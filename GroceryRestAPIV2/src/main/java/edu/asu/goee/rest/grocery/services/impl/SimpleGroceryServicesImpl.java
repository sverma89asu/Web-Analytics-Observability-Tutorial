...
import static edu.asu.goee.rest.grocery.services.ProducerServices.getProducerService;
...
public class SimpleGroceryServicesImpl implements GroceryServices {
	...
	@Override
	public boolean delete(String id) throws NoSuchGroceryItemException {
	...
	public boolean addGroceryProducer(String groceryId, String producerAbbrev) 
			throws NoSuchGroceryItemException, NoSuchProducerException {
