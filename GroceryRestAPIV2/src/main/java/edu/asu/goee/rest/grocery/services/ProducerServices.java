...
public interface ProducerServices {
	...
	public Producer findOne(String abbrev) throws NoSuchProducerException;
	...
	public boolean delete(String abbrev) throws NoSuchProducerException;			// true if id there, false if not
	...
	public static ProducerServices getProducerService() {
		try {
			String __theServiceImpl = "edu.asu.goee.rest.grocery.services.impl.SimpleProducerServicesImpl";
